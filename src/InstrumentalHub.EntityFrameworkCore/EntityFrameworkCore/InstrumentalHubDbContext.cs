...
public class InstrumentalHubDbContext :
    AbpDbContext<InstrumentalHubDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public InstrumentalHubDbContext(DbContextOptions<InstrumentalHubDbContext> options)
        : base(options)
    {
