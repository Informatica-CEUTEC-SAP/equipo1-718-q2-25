...
public class InstrumentalHubDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public InstrumentalHubDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
